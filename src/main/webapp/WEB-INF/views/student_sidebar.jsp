...
<div class="d-flex" id="wrapper">
    <div class="bg-light border-right my-sidebar" id="sidebar-wrapper" style="width: 200px">
        <div class="sidebar-heading"  style="margin: 20px 10px; top: 0px"><a> <b>სტუდენტი</b></a> </div>
        <div class="list-group list-group-flush" style="overflow: auto; height: 90%">
            ...
            <a href="#" class="list-group-item list-group-item-action bg-light">ჩათები</a>
            <a href="/queues-student" class="list-group-item list-group-item-action bg-light">რიგები</a>
