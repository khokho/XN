...
<div class="d-flex" id="wrapper">
    ...
    <div class="full-width" id="page-content-wrapper">
        <!-- Navbar -->
        <nav class="sidebar-wrapper expandable navbar navbar-expand-lg navbar-light bg-light border-bottom" id="nav"
             style="z-index: 9;position: fixed; width: 100%">
            <ul class="navbar-nav">
                <li class="nav-item">
            ...
            <ul class="navbar-nav ml-auto" style="margin-right: 30px">
                <li class="nav-item row">
                    ...
                    <a class="nav-link" style="margin-left: 30px;" id="logout"
                       href="${pageContext.request.contextPath}/logout">გასვლა</a>
                </li>
            </ul>
